...
public class ChessGui extends JFrame {
	...
	public ChessGui() {
		...
		JLabel lblNewLabel = new JLabel("Chess (PvP Only)", SwingConstants.CENTER);
		lblNewLabel.setBackground(new Color(0, 255, 0));
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 28));
		lblNewLabel.setBounds(229, 11, 235, 71);
		...
		//for convenience sake, this button will only show itself 
		//if there was a file to read
